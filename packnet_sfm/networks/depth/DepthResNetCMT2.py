...
from packnet_sfm.networks.depth.cmt_half_cascade_h import CMT, CMT_Ti, CMT_B
...
class DepthResNetCMT2(nn.Module):
    """
    ...
    def __init__(self, version=None, **kwargs):
        ...
        self.de_channels=[64+64, 64+46 , 128+self.embed_dim *2 , 256+self.embed_dim*4, 512+ self.embed_dim * 8]      
    ...
    def forward(self, rgb):
        ...
        swin_out = self.cmt(rgb)
        
        x = []
        for res, swin in zip(resnet_out, swin_out):
            out = torch.cat((res, swin), 1)
            x.append(out)
